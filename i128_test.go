...
func TestI128AsBigIntAndIntoBigInt(t *testing.T) {
	for idx, tc := range []struct {
		...
		{I128{hi: 0, lo: 2}, bigI64(2)},
		{I128{hi: 0xFFFFFFFFFFFFFFFF, lo: 0xFFFFFFFFFFFFFFFE}, bigI64(-2)},
		{I128{hi: 0x1, lo: 0x0}, bigs("18446744073709551616")},
		{I128{hi: 0x1, lo: 0xFFFFFFFFFFFFFFFF}, bigs("36893488147419103231")}, // (1<<65) - 1
		{I128{hi: 0x1, lo: 0x8AC7230489E7FFFF}, bigs("28446744073709551615")},
		{I128{hi: 0x7FFFFFFFFFFFFFFF, lo: 0xFFFFFFFFFFFFFFFF}, bigs("170141183460469231731687303715884105727")},
		{I128{hi: 0xFFFFFFFFFFFFFFFF, lo: 0xFFFFFFFFFFFFFFFF}, bigs("-1")},
		{I128{hi: 0x8000000000000000, lo: 0}, bigs("-170141183460469231731687303715884105728")},
	} {
...
func TestI128FromBigInt(t *testing.T) {
	for idx, tc := range []struct {
		...
		{bigI64(2), i64(2)},
		{bigI64(-2), i64(-2)},
		{bigs("18446744073709551616"), I128{hi: 0x1, lo: 0x0}},                // 1 << 64
		{bigs("36893488147419103231"), I128{hi: 0x1, lo: 0xFFFFFFFFFFFFFFFF}}, // (1<<65) - 1
		...
		{bigs("-1"), I128{hi: 0xFFFFFFFFFFFFFFFF, lo: 0xFFFFFFFFFFFFFFFF}},
	} {
